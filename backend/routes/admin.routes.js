...
router.post('/appointments', isAuthenticated, isAdmin, async (req, res) => {
  const { patientName, patientContact, appointmentDate, appointmentTime, doctorId } = req.body;
  try {
    if (!patientName || !patientContact || !appointmentDate || !appointmentTime || !doctorId) {
...
router.get('/patients/:id/appointments', isAuthenticated, isAdmin, async (req, res) => {
  try {
...
router.put('/appointments/:id/status', isAuthenticated, isAdmin, async (req, res) => {
...
router.post('/doctors', isAuthenticated, isAdmin, async (req, res) => {
...
router.put('/doctors/:id/availability', isAuthenticated, isAdmin, async (req, res) => {
